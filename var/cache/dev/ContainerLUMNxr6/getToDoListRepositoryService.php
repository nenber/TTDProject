 ...
 */
class getToDoListRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ToDoListRepository.php';

        return $container->privates['App\\Repository\\ToDoListRepository'] = new \App\Repository\ToDoListRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
